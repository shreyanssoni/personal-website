    ...
    <article className="signal-card mb-5 overflow-hidden">
      ...
      >
        <div className="flex items-start gap-4">
          {/* Left: icon dot */}
          <div className={`mt-1 w-9 h-9 rounded-xl ${colors.bg} flex items-center justify-center shrink-0`}>
          ...
          <div className="flex-1 min-w-0">
            ...
            {/* Title */}
            <h3 className="font-[family-name:var(--font-serif)] text-[17px] md:text-lg font-bold text-stone-800 leading-snug mb-2">
              {signal.title}
            </h3>

            {/* So What */}
            <p className="font-[family-name:var(--font-body)] text-[14px] text-stone-500 leading-snug font-medium">
              {signal.so_what}
            </p>
          </div>
        ...
        <div className="overflow-hidden">
          <div className="px-5 md:px-6 pb-5 md:pb-6 pt-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-stone-50/60 rounded-xl p-4">
                <p className="font-[family-name:var(--font-mono)] text-[8px] tracking-[0.2em] uppercase text-stone-400 mb-1.5 font-bold">
                  What changed
                </p>
                <p className="font-[family-name:var(--font-body)] text-[13px] text-stone-600 leading-relaxed">
                  {signal.delta}
                </p>
              </div>
              <div className="bg-stone-50/60 rounded-xl p-4">
            ...
            {signal.how_to_use && (
              <div className="mt-3 bg-amber-50/50 border border-amber-100/60 rounded-xl px-4 py-3">
                <p className="font-[family-name:var(--font-body)] text-[13px] text-amber-800/80 font-medium">
                  → {signal.how_to_use}
                </p>
              </div>
            )}
