...
const About = ({profile, projects}) => {
  ...
  return (
    ...
    <Head>
        ...
        <meta name="description" content='I am Shreyans Soni, a pre-final year student pursuing Electronics and Instrumentation from BITS Pilani, Hyderabad Campus. With having discovered special interest in creation, development and writing, I have been involved in AI and Web dev for more than two years. My other interests include tinkering with electronic components, making sounds using guitar and hitting a shuttle with racket. '/>
        <link
          rel="icon"
